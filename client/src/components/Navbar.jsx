...
const Navbar = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="lg:flex-1 flex flex-row max-2-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-full">
        <input
          type="text"
        ...
        <div className="w-[72px] h-full rounded-[20px] bg-[#4acd8d] flex justify-center items-center cursor-pointer brightness">
          <img
            src={search}
            alt="search_icon"
